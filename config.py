...
# Pre-simulated releases directory (for trimmed model)
PRESIM_DIR = OUTPUT_DIR / "presim"

# Create directories if they don't exist
for d in [OUTPUT_DIR, SAMPLES_DIR, SIMULATIONS_DIR, METRICS_DIR, ANALYSIS_DIR, FIGURES_DIR, PRESIM_DIR]:
...
# =============================================================================
# Use trimmed model for faster runtime (replaces independent STARFIT reservoirs
# with pre-simulated releases). Reduces runtime by ~50-70%.
USE_TRIMMED_MODEL = True

# Path to pre-simulated releases file (generated by 00_generate_presimulated_releases.py)
